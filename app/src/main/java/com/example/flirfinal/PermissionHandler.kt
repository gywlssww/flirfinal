...
public class PermissionHandler(showMessage: MainActivity.ShowMessage, mainActivity: MainActivity) {
    private val mainActivity: MainActivity
    var showMessage: MainActivity.ShowMessage
    ...
    private fun checkPermission(permission: String): Boolean {
        ...
        val checkPermission = mainActivity.checkPermission(
            permission,
            Process.myPid(),
            Process.myUid()
        )
    ...
    companion object {
        ...
        @VisibleForTesting
        var PERMISSIONS_FOR_NW_DISCOVERY = arrayOf(
        ...
        @VisibleForTesting
        var PERMISSIONS_FOR_STORAGE_DISCOVERY = arrayOf(
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.READ_EXTERNAL_STORAGE
        )

        @VisibleForTesting
        var PERMISSIONS_FOR_BLUETOOTH = arrayOf(
